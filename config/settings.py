...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-#=e51f78f*f#tdjx!y17b!qg3mks3&n#ti_&26etot#yq_+@*k')
...
# Автоматически добавляем Render домен
RENDER_EXTERNAL_HOSTNAME = os.environ.get('RENDER_EXTERNAL_HOSTNAME')
if RENDER_EXTERNAL_HOSTNAME:
    ALLOWED_HOSTS.append(RENDER_EXTERNAL_HOSTNAME)
# Также добавляем стандартные хосты Render
if not DEBUG:
...
# Папка для загруженных медиа-файлов (изображения новостей)
MEDIA_URL = '/media/'
